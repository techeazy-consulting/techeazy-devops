...
aws_access_key_id     = aws-access-key-id # Replace with your actual AWS Access Key ID
aws_secret_access_key = aws-secret-access-key # Replace with your actual AWS Secret Access Key
